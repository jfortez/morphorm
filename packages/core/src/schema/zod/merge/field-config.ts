...
>(config: FieldConfig<AdditionalRenderable, FieldTypes, FieldWrapper, CustomData>) {
...
export function getFieldConfigInZodStack(schema: AnyZodSchema): FieldConfig | undefined {
