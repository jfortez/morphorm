...
function isOptional<SchemaType extends z.$ZodType>(schema: SchemaType): boolean {
...
function getDescription<SchemaType extends z.$ZodType>(schema: SchemaType): string | undefined {
